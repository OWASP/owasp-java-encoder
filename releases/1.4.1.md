...
Maven cache. All 1,160 unit and packaged compatibility tests passed. The optional
Docker-based Jakarta browser test was not run because Docker was unavailable.
